...
!(function (e, t) {
							...
							(r = e[t]),
								"__proto__" !== t &&
									...
									(l && r && (ce.isPlainObject(r) || (i = Array.isArray(r)))
										? ((n = a[t]),
										  (o =
												i && !Array.isArray(n) ? [] : i || ce.isPlainObject(n) ? n : {}),
										  (i = !1),
										  (a[t] = ce.extend(l, o, r)))
										: void 0 !== r && (a[t] = r));
				return a;
	...
	!(function () {
		...
		(ce.uniqueSort = function (e) {
			var t,
				...
				i = 0;
			if (
				((a = !le.sortStable), (o = !le.sortStable && ae.call(e, 0)), pe.call(e, l), a)
			) {
	...
	(Te.tbody = Te.tfoot = Te.colgroup = Te.caption = Te.thead),
		(Te.th = Te.td),
		le.option ||
			(Te.optgroup = Te.option = [1, "<select multiple='multiple'>", "</select>"]);
	var Se = /<|&#?\w+;/;
	...
	ce.extend({
		...
		clone: function (e, t, n) {
			var r,
				...
				f = J(e);
			if (
				!(le.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || ce.isXMLDoc(e))
			)
	...
	function at(e, t, n) {
		var r = ze(e),
			i =
				(!le.boxSizingReliable() || n) && "border-box" === ce.css(e, "boxSizing", !1, r),
			o = i,
			a = Ve(e, t, r),
	...
	ce.fn.extend({
		...
		ce.each(ce.expr.match.bool.source.match(/\w+/g), function (e, t) {
			...
			ut[t] = function (e, t, n) {
				...
				return (
					n ||
						((i = ut[o]), (ut[o] = r), (r = null != a(e, t, n) ? o : null), (ut[o] = i)),
					r
				);
			};
		});
